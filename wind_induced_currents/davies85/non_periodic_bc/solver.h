#ifndef WIND_INDUCED_CURRENTS_DAVIES85_NON_PERIODIC_BC_SOLVER_H
#define WIND_INDUCED_CURRENTS_DAVIES85_NON_PERIODIC_BC_SOLVER_H
...
namespace WindInducedCurrents::Davies85::NonPeriodicBC {
    enum GenerateH {
        UniformH = 0,
        CosineH = 1
    };
