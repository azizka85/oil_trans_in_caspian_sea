#ifndef WIND_INDUCED_CURRENTS_DAVIES85_VARIABLE_STEP_SIZE_VARIABLE_DEPTH_SOLVER_H
#define WIND_INDUCED_CURRENTS_DAVIES85_VARIABLE_STEP_SIZE_VARIABLE_DEPTH_SOLVER_H
...
namespace WindInducedCurrents::Davies85::VariableStepSize::VariableDepth {
    class Solver {
        private:
            double f;
            double b;
            ...
            tuple<double, double> minMaxH();

            path createDirectory(double dzm, double hMin, double hMax);
